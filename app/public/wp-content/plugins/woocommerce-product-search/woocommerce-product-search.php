 ...
 *
 * Copyright (c) 2014-2017 "kento" Karim Rahimpur www.itthinx.com
 *
...
define( 'WOO_PS_PLUGIN_VERSION', '1.10.3' );
...
function woocommerce_product_search_plugins_loaded() {
...
add_action( 'plugins_loaded', 'woocommerce_product_search_plugins_loaded' );
